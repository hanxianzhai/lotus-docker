...
/home/xxx/bin/lotus-worker run --no-swap --listen 0.0.0.0:8976 --addpiece=false --precommit1=true --precommit2=false --commit=false --parallel-fetch-limit 7 --pc1-num 7
